        ...
        <div className="flex items-center gap-2 mt-auto pt-1 flex-wrap">
          {item.url && (
            <a
              ...
              rel="noopener noreferrer"
              title="Open"
              className="border border-gray-300 dark:border-gray-600 rounded p-1 text-gray-500 dark:text-gray-400 hover:border-gray-500 hover:text-gray-900 dark:hover:text-white transition-colors flex items-center justify-center"
            >
